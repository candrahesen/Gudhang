...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            textView = (TextView) v.findViewById(R.id.namaProduk);
            textView2 = (TextView) v.findViewById(R.id.harga);
            textView3 = (TextView) v.findViewById(R.id.lokasi);
            textView4 = (TextView) v.findViewById(R.id.grosir);
            imageView = (ImageView) v.findViewById(R.id.fotoProduk);
        }
